    ...
    <div>
      ...
      <section id='contact-form' className='get-in-touch text-white py-10 px-4'>
        <div className='max-w-4xl  m-auto my-14'>
            ...
            <p className='md:text-lg my-5 text-justify text-gray-700'>Bit Bridge Global is a trusted digital payment platform designed to make financial transactions seamless, secure, and efficient. We specialize in utility payment services and connecting buyers to sellers in our online market place. </p>
            ...
            <h3 className='text-2xl text-primary font-semibold'>    Why Choose Bit Bridge Global? </h3>
                ...
                <div>
                    ...
                    <p className='text-base text-gray-800 my-5'> Experience the convenience of trading gift cards and paying your bills with *Bit Bridge Global*. Get started today!               </p>
