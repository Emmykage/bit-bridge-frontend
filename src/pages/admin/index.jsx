      ...
      <div className="bg flex-1 bg-red">
        <div className="min-h-60 w-full gap-4 flex-col sm:flex-row flex bg-white  p-4 400">
          ...
          <div className="flex flex-col justify-center shadow flex-1 items-center">
            ...
            <span className="text-gray-700">AMOUNT WITHDRAWN</span>
            <p className="text-gray-700 text-lg font-semibold">
        ...
        <div className="min-h-[300px]  flex flex-col lg:flex-row gap-3 my-4">
                    ...
                    <table className="min-w-full bg-gray-300 border border-gray-200 rounded-md border-separate border-spacing-0 table-auto overflow-hidden">
                      <thead>
                        <tr>
                          ...
                          <th
                            scope="col"
                            className="sticky top-0 z-10 border-b border-gray-200/50  bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8 text-nowrap"
                          >
                            {' '}
                            TOTAL AMOUNT
                          </th>
                          <th
                            scope="col"
                            className="sticky top-0 z-10 hidden border-b border-gray-200/50  bg-opacity-75 px-6 py-3.5  text-center text-xs font-semibold text-gray-900 backdrop-blur backdrop-filter sm:table-cell"
                          >
                            STATUS
                          </th>
                          <th
                          ...
                          <th
                            scope="col"
                            className="sticky top-0 z-10 hidden border-b border-gray-200/50 bg- bg-opacity-75 px-3 py-3.5 text-center text-xs font-semibold text-gray-900 backdrop-blur backdrop-filter lg:table-cell"
                          >
                            TIME{' '}
                          </th>
                        </tr>
          ...
          <div className="lg:w-52 space-y-4 ">
            <NavLink
              ...
              className="py-3 block rounded text-white text-center w-full bg-gray-900"
            >
              Add Product
            </NavLink>
            <NavLink
