  ...
  const ConfirmEmail = () => {
    ...
    return (
      <div className='h-screen bg-gray-900 w-full flex flex-col justify-center items-center gap-4'>
        ...
        {user?.confirmed_at ? <p className='text-white text-lg'>Email has been confirmed</p> : <p className='text-white text-lg'>Email Confirmation has been sent to {email} </p>}
        <div>
        ...
        <p className='text-gray-500 text-sm'>If you have not received a confirmation email, please check your spam folder or 
          
          <NavLink to="/send-confirmation" className='text-purple-200 font-semibold'>resend confirmation</NavLink>.</p>
