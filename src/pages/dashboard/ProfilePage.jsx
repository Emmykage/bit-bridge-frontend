...
const ProfileAccountPage = () => {
    ...
    const handleUserDelete = () => {
        dispatch(SET_LOADING(true))
        dispatch(userDelete(user.id)).then(
      ...
      <div className="bg-white shadow-md rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input value={userInfo?.user_profile?.first_name} name='first_name' onChange={(e)=> setUserInfo( {...userInfo, user_profile: {...userInfo.user_profile,first_name: e.target.value}})} type="text" className="mt-1 block w-full rounded-md border border-gray-300 p-2" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">Last Name</label>
            <input value={userInfo?.user_profile?.last_name} name='last_name' type="text" onChange={(e)=> setUserInfo({...userInfo,  user_profile: {...userInfo.user_profile, last_name: e.target.value}})} className="mt-1 block w-full rounded-md border border-gray-300 p-2" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">Phone Number</label>
            <input value={userInfo?.user_profile?.phone_number} name='phone_number' type="text" onChange={(e)=> setUserInfo({...userInfo, user_profile: {...userInfo.user_profile, phone_number: e.target.value}})} className="mt-1 block w-full rounded-md border border-gray-300 p-2" />
          </div>
          <div>
