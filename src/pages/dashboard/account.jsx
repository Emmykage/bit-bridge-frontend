                                ...
                                <div className="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
                                    <div className="inline-block min-w-full py-2 align-middle">
                                        ...
                                        <table className="min-w-full  border border-gray-700 rounded-md border-separate border-spacing-0 table-auto overflow-hidden">
                                            ...
                                            <tr>
                                            <th scope="col" className="sticky top-0 z-10 border-b border-gray-600/50  bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-300 uppercase backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">  transaction</th>
                                            <th scope="col" className="sticky top-0 z-10 border-b border-gray-600/50  bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-300 uppercase backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">  status</th>
                                            <th scope="col" className="sticky top-0 z-10 border-b border-gray-600/50 bg-opacity-75 px-3 py-3.5 text-center text-xs font-semibold text-gray-300 uppercase backdrop-blur backdrop-filter">Amount</th>
                                            ...
                                            <tbody>
                                                ...
                                                { wallet.transactions?.map(item => (
                                                    ...
                                                    <td className="whitespace-nowrap border-b border-gray-200 py-2 pl-3 pr-3 text-sm font-normal sm:pl-6 lg:pl-8">
                                                        <p className=" text-gray-400 leading-5 capitalize text-sm font-semibold">{item.transaction_type} </p>
                                                    </td>
                                                    ...
                                                    <td className="whitespace-nowrap border-b border-gray-200 px-3 py-3 text-sm text-gray-100 text-center font-semibold "><p className="font-bold">{nairaFormat(item.amount, wallet.wallet_type)}</p></td>
