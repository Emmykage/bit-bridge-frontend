...
const ConfirmPayment = () => {
 ...
 const refId = searchParams.get("paymentReference")
  ...
  return (<div className='bg-gray-900 min-h-screen text-white p-6'>
...
{purchaseOrder &&
        ...
        {refId.startsWith("fbg") ? <div className="bg-gray-900 text-white  flex items-center justify-center">
