...
export const createCardToken = createAsyncThunk("card-token/create-order-token", async(data, {rejectWithValue}) => {
...
export const getCardTokens = createAsyncThunk("card-token/get-order-token", async(data, {rejectWithValue}) => {
