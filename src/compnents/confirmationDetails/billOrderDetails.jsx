        ...
        <h2>
          {purchaseOrder?.token && (
            <div className="  md:flex-row flex-col my-4 flex gap-4">
              <p className="md:w-60 border-b  border-gray-700 px-2 font-semibold">
                Token
              </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          {purchaseOrder?.name && (
            <Detail
              ...
              hidden={
                purchaseOrder?.service_type === "VTU" ||
                purchaseOrder?.service_type === "VTU"
              }
            />
          )}
          ...
          {purchaseOrder?.amount && (
            ...
            <Detail
              ...
              commission={
                purchaseOrder?.bill_commission &&
                nairaFormat(purchaseOrder?.bill_commission)
              }
          ...
          {purchaseOrder?.amount && (
            ...
            <Detail
              ...
              value={nairaFormat(purchaseOrder?.service_charge)}
            />
          )}
          ...
          {purchaseOrder?.transaction_id && (
            ...
            <Detail
              ...
              value={purchaseOrder?.transaction_id}
            />
          )}
          ...
          {purchaseOrder?.email && (
            <Detail
              label={"Email"}
              value={purchaseOrder?.email ?? user?.emal}
            />
          )}
        </div>
      </div>
  ...
  <div className={`${hidden ? "hidden" : "flex"} flex-col`}>
    ...
    {badge ? (
      ...
      <p className="flex gap-5">
        <span
          className={`text-white mt-1 ${applyCommission && "line-through"}`}
        >
          {value}
        </span>
